...
public class TestCaseRunner
{
    ...
    public void runTestCase(Map<String, String> testSuiteVars, List<Executor> executors, Testcase testCase)
    {
        TestSuite.StepResult lastStepResult = null;
        for(TestSuite.Step step : testCase.steps)
        {
            lastStepResult = testStepRunner.runStep(testSuiteVars, executors, testCase, step, lastStepResult);
        }
